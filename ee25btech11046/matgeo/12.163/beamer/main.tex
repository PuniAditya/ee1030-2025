...
\begin{enumerate}
    \item[a)] Scaling and Translation
    \item[b)] Scaling and Rotation
    \item[c)] Rotation and Translation
    \item[d)] Rotation
\end{enumerate}
\end{frame}
...
\begin{frame}{Example}
Applying the transformation to the point $\myvec{1 \\ 1}$. In homogeneous coordinates, using \eqref{eq:47}
\begin{align}
...
The correct option is \textbf{a) Scaling and Translation}.
\end{frame}
